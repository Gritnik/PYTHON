...
hw_list = ['в', '5', 'часов', '17', 'минут', 'температура', 'воздуха', 'была', '+5', 'градусов']
new_list = []
for obj in hw_list:
    number = ''
    text1 = ''
    text2 = ''
    for simbols in obj:
        if simbols in '1234567890':
            number = number + simbols
            #print(number)
        else:
            if number:
                text2 = text2 + simbols
...
# НЕ МОГУ ПОНЯТЬ КАК ДОБАВИТЬ 0 ЧТОБЫ БЫЛО "05 ГРАДУСОВ(((